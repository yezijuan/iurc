...
<html>
		...
		$(function(){
			$.ajax({
				...
				success:function(data){
					...
					if(data.state==1){
						$("#personal").tree({				
								url:"personalmenu.json"
							});
							$("#menu").append(
							'<a href="Community.jsp" target="_blank" style="text-decoration: none;margin: 20px;">主题中心</a>'
						);
					}
					if(data.state==2){
						$("#personal").tree({				
								url:"personalmenu2.json"
							});
							$("#menu").append(
							'<a href="Community.jsp" target="_blank" style="text-decoration: none;margin: 20px;">主题中心</a>'
						);
					...
					if(data.state==3){
						$("#personal").tree({				
								url:"personalmenu3.json"
							});
						$("#menu").append(
							'<a href="Community.jsp" target="_blank" style="text-decoration: none;margin: 30px;">主题中心</a>'+
							'<a href="admin/adminCenter.jsp" target="_blank" style="text-decoration: none;margin: 30px;">管理员中心</a>'
						);
					}	
				}
			});
  ...
  <body>
    <div id="cc" class="easyui-layout" data-options="fit:true">
    	...
    	<div data-options="region:'west',title:'目录',split:false" style="width: 150px;" id="menu">
    		<ul id="personal"></ul>
    	</div>
