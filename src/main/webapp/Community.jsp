...
<html>
  ...
  <body>
    <div id="cc" class="easyui-layout" data-options="fit:true">
    	<div data-options="region:'north',split:false" style="height: 137px;">
    		<!-- 头部  logo 登录信息 登录跳转
			================================================== -->
			<div class="container" >
			...
			<div class="container">
				<div> 
					<div class="input-group">
					  <span class="input-group-addon" id="basic-addon2"  style="width: 200px; height:34px; float: left; text-align: right;background-color: white;border: 0;font-size: 23px;">产学研社区：</span>
					  <input type="text" class="form-control" placeholder="输入要查询的帖子主题内容" aria-describedby="basic-addon2" style="width: 740px; height:34px;">
					  <input type="button"  style="width: 100px; height:34px;" value="查询" id="" ></input>
					</div>
				</div>
			</div>
    	</div>
    	...
    	<!-- 左边
		================================================== -->
    	<div data-options="region:'west',title:'',split:false" style="width: 150px;">
    		<ul >
	          <li style="list-style:none;">
	            <img  alt="头像" src="${user!=null? user.img :'images/timg.jpg'}" style="width: 50px;height: 50px;"/>
	          </li>
