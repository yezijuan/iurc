...
<html>
  <head>
    ...
    <title>单位</title>
    <script type="text/javascript" src="admin/js/cooperation.js"></script>
    <style type="text/css">
    	input{
    		width: 200px;
    		height: 20px;
    	...
    	<form id="ff" method="post">   
    		...
    		<table style="float: left;">
    			<tr>
    				...
    				<td><input type="text" name="cUnitId" class="easyui-numberbox" ></td>
    			</tr> 
    			<tr>
    				<td class="label">项目编号：</td>
    				<td><input type="text" name="projectId" class="easyui-textbox" ></td>
    			</tr>  
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="cooperatedTime" class="easyui-datetimebox" ></td>
    			</tr>
    			<tr>
