    	...
    	function remove(){
			...
			$.messager.confirm("提示消息","您确定要删除这"+array.length+"条记录？",function(r){
				...
				if(r){
					...
					$.ajax({
						url:"collection/deleteMore?ids="+ids,
						type:"post",
						dataType:"json",
