...
<html>
  <head>
    ...
    <title>单位</title>
    <script type="text/javascript" src="admin/js/checked.js"></script>
    <style type="text/css">
    	input{
    		width: 200px;
    		height: 20px;
    ...
    <div id="dd" class="easyui-dialog"  closed="true">
    	<form id="ff" method="post">   
    		...
    		<table style="float: left;">
    			<tr>
    				<td class="label">审核用户：</td>
    				<td><input type="text" name="uid" class="easyui-numberbox" ></td>
    			</tr>
    			<tr>
    				<td class="label">审核类型：</td>
    				<td><input type="text" name="type" class="easyui-numberbox" ></td>
    			</tr>
    			<tr>
    				<td class="label">类型编号：</td>
    				<td><input type="text" name="typeId" class="easyui-numberbox" ></td>
    			</tr>
    			<tr>
    				<td class="label">审核时间：</td>
    				<td><input type="text" name="checkTime" class="easyui-datetimebox" ></td>
    			</tr>
    			<tr>
